    ...
    <div className="pt-20 min-h-screen bg-hex">
      ...
      <section className="relative py-24 overflow-hidden mb-20 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10 text-center">
          <h1 className="text-5xl font-bold mb-6 text-white text-white">Let's Talk Tech</h1>
          <p className="text-slate-300 text-xl max-w-2xl mx-auto">Have a project in mind or need a professional consultation? Reach out today.</p>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 flex items-start gap-5">
              ...
              <div>
                <h4 className="font-bold text-lg mb-1">Call Us Anywhere</h4>
            ...
            <div className="rounded-3xl overflow-hidden h-64 shadow-inner border border-slate-200">
               <iframe 
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button 
                    ...
                    className="w-full py-5 teal-gradient text-white rounded-2xl font-bold flex items-center justify-center gap-3 shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
                  >
                    {isSubmitting ? (
