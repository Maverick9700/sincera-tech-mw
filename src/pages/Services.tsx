    ...
    <div className="pt-20">
      ...
      <section className="relative py-24 overflow-hidden mb-20 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
          <h1 className="text-5xl font-bold mb-6 text-white text-white">Our Services</h1>
          <p className="text-slate-300 text-xl max-w-3xl">Professional technology solutions tailored to help businesses in Malawi scale efficiently and securely.</p>
        </div>
      </section>
        ...
        <div className="space-y-32">
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="lg:w-1/2 bg-slate-200 rounded-3xl overflow-hidden aspect-video shadow-xl">
                 <img 
